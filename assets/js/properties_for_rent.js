...
const showProperties = (properties, containerId) => {
    ...
    const propertiesLimited = properties
    ...
    <p class="${property.smoke ? 'text-success' : 'text-danger'}"><i class="fa-solid fa-ban-smoking"></i> ${property.smoke ? 'Permitido fumar' : 'No se permite fumar' }</p>
    <p class="${property.pets ? 'text-success' : 'text-danger'}"><i class="fa-solid fa-dog"></i> ${property.pets ? 'Mascotas permitidas' : 'No se permiten mascotas'}</p>
    </div>
    </div>
    `
